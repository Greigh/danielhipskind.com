...
export const ARTICLE_LIMIT = 200;

// Request settings
export const CONCURRENT_REQUESTS = parseInt(process.env.CONCURRENT_REQUESTS, 10) || 10;
...
export const DEFAULT_IMAGE = '/assets/images/placeholder.jpg';
